...
def run_scaled_dot_product_attention(
    ...
    """
    return nn.scaled_dot_product_attention(Q, K, V, mask)
...
def run_rope(
    ...
    """
    model = nn.RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_cross_entropy(
    ...
    """
    return nn.cross_entropy_loss(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return optim.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return optim.lr_cosine_schedule(
        it,
        max_learning_rate,
        min_learning_rate,
        warmup_iters,
